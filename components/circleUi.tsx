...
const CircleUi: React.FC<CircleUiProps> = ({ 
  ...
  return (
    <div className="relative inline-block mb-6">
      <div className={cn(
        "rounded-full border border-dashed border-[rgba(255,255,255,0.2)] flex items-center justify-center animate-[spin_14s_linear_infinite]",
        largeCircle ? "w-48 h-48" : "w-32 h-32"
      )}>
         <svg className="absolute w-full h-full" viewBox="0 0 100 100">
            <path id="circlePath" d="M 50, 50 m -37, 0 a 37,37 0 1,1 74,0 a 37,37 0 1,1 -74,0" fill="none" />
            <text className={cn(
              "uppercase tracking-[0.2em] fill-muted-foreground font-medium",
