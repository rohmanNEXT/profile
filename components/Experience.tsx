  ...
  return (
    <section className="section-padding flex flex-col items-center">
      ...
      <div className="max-w-3xl w-full relative">
        {/* Timeline line */}
        <div className="absolute left-1/2 -translate-x-1/2 top-0 bottom-0 w-0.5 bg-muted-foreground/20 hidden md:block" />
            ...
            >
              ...
              >
                ...
                <div className="flex justify-start">
                  <span className="text-[9px] bg-primary/5 text-primary/80 px-3 py-1 rounded-full border border-primary/10 flex items-center gap-2 font-medium uppercase tracking-widest">
                    <Briefcase size={10} />
                    {exp.category}
                  </span>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-2 text-xs text-muted-foreground/80">
                    ...
                    <div className="flex flex-wrap gap-3 mt-4 text-[9px]">
                      <div className="inline-flex items-center gap-3 bg-primary/5 px-3 h-7 rounded-full text-primary/80 font-medium shadow-inner border border-primary/10">
                        <Clock size={10} />
                ...
                <div className="space-y-3 pt-4 border-t border-border">
                  <p className="font-medium text-[9px] uppercase tracking-[0.2em] text-muted-foreground/60">
                    Key Achievements
                  </p>
                  <ul className="space-y-2">
                    {exp.achievements.map((item, iIdx) => (
                      <li
                        key={iIdx}
                        className="text-xs text-muted-foreground/70 flex items-start gap-3 leading-relaxed"
                      >
