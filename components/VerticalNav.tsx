    ...
    <div className="fixed left-6 top-1/2 -translate-y-1/2 z-50 hidden lg:flex flex-col items-center gap-8">
      ...
      {SECTIONS.map((section) => (
        ...
        >
          ...
          <span
            className={cn(
              "absolute left-8 whitespace-nowrap text-xs font-medium uppercase tracking-widest transition-all duration-300 opacity-0 -translate-x-4 group-hover:opacity-100 group-hover:translate-x-0",
              activeSection === section.id
